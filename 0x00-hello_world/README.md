...
5. 4-puts | print the word between the qoute to the screen.
6. 5-printf.c | uses the printf funtion to print to the screen.
7. 6-sice.c | Print the size of the various types on the computer the code is compiled and run on.
8. 100-intel | generate the assembly code (intel syntax) of a C code ans save it in an output file.
9. 101-quote.c | print exactly what is in the quotes. Concept used arrays.
